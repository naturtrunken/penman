...
shared_context 'Api::V1::User::NetworksController#index shared spec' do
  describe 'GET #index' do
    before do
      # Create an user with three networks.
      @user = FactoryBot.create(:user)
      1.upto(3).each { FactoryBot.create(:network, user_id: @user.id) }
    end
    ...
    describe 'as the user who created the networks' do
      ...
      it 'should return four networks' do
        ...
        expect(json['networks'].count).to eq(3)
      end
    end
