...
shared_context 'Api::V1::User::Network::Target::ServicesController#destroy shared spec' do
  describe 'DELETE #destroy' do
    before do
      ...
      @service = FactoryBot.create(:service, user_network_target_id: @target.id)
    end
    ...
    describe 'as the user who created the targets' do
      ...
      it 'should have been deleted the target' do
        expect(User::Network::Target::Service.where(id: @service.id).count).to eq(0)
      end
    end
    ...
    describe 'as another user' do
      ...
      it 'should not have been created the target' do
        expect(User::Network::Target::Service.where(id: @service.id).count).to eq(1)
      end
    end
