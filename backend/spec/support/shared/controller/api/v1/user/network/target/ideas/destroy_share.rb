...
shared_context 'Api::V1::User::Network::Target::IdeasController#destroy shared spec' do
  describe 'DELETE #destroy' do
    ...
    describe 'as the user who created the targets' do
      ...
      it 'should have been deleted the Idea' do
        expect(User::Network::Target::Idea.where(id: @idea.id).count).to eq(0)
      end
    end
    ...
    describe 'as another user' do
      ...
      it 'should not have been created the Idea' do
        expect(User::Network::Target::Idea.where(id: @idea.id).count).to eq(1)
      end
    end
