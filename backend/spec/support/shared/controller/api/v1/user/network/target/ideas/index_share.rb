...
shared_context 'Api::V1::User::Network::Target::IdeasController#index shared spec' do
  describe 'GET #index' do
    before do
      ...
      1.upto(3).each { FactoryBot.create(:idea, user_network_target_id: @target.id) }
    end
    ...
    describe 'as the user who created the target' do
      ...
      it 'should return three attack vectors' do
        ...
        expect(json['ideas'].count).to eq(3)
      end
    end
